...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      clearIdle: 'Clear Idle',
      clearIdleTitle: 'Release idle sessions to free active-session slots',
      sessionsReleased: (count: number) => `${count} session${count === 1 ? '' : 's'} released`,
      noIdleToRelease: 'No idle sessions to release',
