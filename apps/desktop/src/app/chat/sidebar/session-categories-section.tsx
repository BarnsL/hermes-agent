...
// session row onto a category (native HTML5 drag or the pointer fallback —
// see category-drop-zone.tsx) to file it there. Categories are a VIEW over
// sessions: the flat recents list still shows everything.
