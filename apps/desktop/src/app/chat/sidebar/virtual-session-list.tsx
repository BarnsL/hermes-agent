...
export const VirtualSessionList: FC<VirtualSessionListProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // Visible range shifts commit near every frame during wheel scrolling.
    // Measuring layout on each one forces a synchronous reflow; content above
    // this list is stable during the gesture, so remeasure once scrolling
    // settles instead.
  ...
  // Keep per-session closures behind a memo boundary. The virtualizer notifies
  // on nearly every scroll frame, but rows whose primitive state did not
  // change should not reconcile their menu and tooltip subtrees again.
