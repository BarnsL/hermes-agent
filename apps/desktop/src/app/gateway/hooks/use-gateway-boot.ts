...
// After this many consecutive failed reconnects (≈30s with the 0,1,2,4,8,15s
// backoff) raise a recoverable boot error. Otherwise a dropped remote gateway
// loops the backoff forever behind the fullscreen CONNECTING overlay with no way
// to reach Settings / sign in / switch to local — the "lost connection breaks
// the app" dead end. The next successful reconnect clears it.
